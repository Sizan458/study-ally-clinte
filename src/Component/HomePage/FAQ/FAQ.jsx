...
const Faq = () => {
  ...
  <div className="collapse collapse-arrow join-item border  border-base-300 dark:text-emerald-500">
    <input type="radio" name="my-accordion-4"  /> 
    <div className="collapse-title text-xl font-medium ">
    How do I submit assignment  on website?
    </div>
    <div className="collapse-content "> 
      <p className=" dark:text-emerald-500" >Go to assignment page .There you will see a  from</p>
    </div>
  </div>
  <div className="collapse collapse-arrow join-item border border-base-300  dark:text-emerald-500">
    <input type="radio" name="my-accordion-4" /> 
    ...
    <div className="collapse-content"> 
      <p className=" dark:text-emerald-500">Yes</p>
    </div>
  </div>
  <div className="collapse collapse-arrow join-item border border-base-300">
    ...
    <div className="collapse-content"> 
      <p className=" dark:text-emerald-500">24/7</p>
    </div>
  </div>
  <div className="collapse collapse-arrow join-item border border-base-300  dark:text-emerald-500">
    <input type="radio" name="my-accordion-4" /> 
